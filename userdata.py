...
for i in data_info['users']:
    try:
        sql = "INSERT INTO `userdata`(`firstname`, `lastname`, `maidenname`, `age`, `gender`, `email`, `phone`, `username`, `password`, `dob`, `bloodgroup`, `height`, `weight`, `eyecolor`) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
